...
function contentloader(uri, lang) {
    ...
    $("#properties").load("php/details.php?lang=" + lang + "&URI=" + uri + " #eigenschaften");
    $("#contact").load("php/details.php?lang=" + lang + "&URI=" + uri + " #address");
    $("#opening").load("php/details.php?lang=" + lang + "&URI=" + uri + " #openinghours");
